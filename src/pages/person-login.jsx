...
export default function Error() {
  ...
  const handleSubmit = async (e) => {
    ...
    loginDispatch(login({ username: e.username, password: e.password, userType: e.userType, type: UserType.PERSON }))
    ...
    <div style={{ fontFamily: 'Vazir' }}>
      ...
      <SectionFullScreen bg="bg-hero-pattern">
        <CardBox className="w-11/12 md:w-7/12 lg:w-6/12 xl:w-4/12 shadow-2xl z-50">
          ...
          <Formik
            initialValues={{ username: '', password: '', remember: true, userType: '3' }}
          ...
          >
            {({ errors }) => (
              <Form className='z-50'>
                ...
                <BaseButtons className='flex w-100 justify-between'>
                  ...
                  <BaseButton onClick={redirectToPersonRegistration} type="button" label="ثبت نام در سامانه" color="success" />
                </BaseButtons>
              </Form>
            )}
          </Formik>
