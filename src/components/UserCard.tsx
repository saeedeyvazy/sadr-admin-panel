  ...
  return (
    <CardBox className={className}>
      <div className="flex flex-col lg:flex-row items-center justify-around lg:justify-center">
        ...
        <div className="space-y-3 text-center md:text-right lg:mx-12">
          ...
          <p>
            آخرین ورود به سامانه <b>12 دقیقه پیش</b> از <b>127.0.0.1</b>
          </p>
          <div className="flex justify-center md:block">
            <PillTag label="تایید شده" color="info" icon={mdiCheckDecagram} />
          </div>
        </div>
      </div>
    </CardBox>
